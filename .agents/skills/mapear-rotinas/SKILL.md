...
Ler `templates/skills/catalogo.md` pra ver se alguma das tarefas mencionadas já é coberta por uma skill nativa do Codex ou validada pelo Sety Vision. Se sim, sugerir a skill existente em vez de criar uma nova:
